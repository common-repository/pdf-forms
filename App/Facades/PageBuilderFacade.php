		...
		if ( $this->has_settings() ) {
			foreach ( $this->settings as $section => $settings ) {
				foreach ( $settings as &$setting ) {
					...
					$settingSlug = array_key_exists('slug', $setting) ? $setting['slug'] : '';
                    $settingTitle = array_key_exists('title', $setting) ? $setting['title'] : '';

					add_settings_field( $settingSlug, $settingTitle, array( $this, 'displaySettings' ), $section, $section, $setting );
				}

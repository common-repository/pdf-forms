...
use PdfFormsLoader\Core\{Views, Assets};
...
class Switcher
{
    ...
    public function output()
    {
        ...
        $disabled = array_key_exists('disabled', $this->settings) ? "readonly disabled" : '';
        unset($this->settings['values'], $this->settings['name'], $this->settings['value'], $this->settings['disabled']);
        $attributes = '';
